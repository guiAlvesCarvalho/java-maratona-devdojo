...
public class DateTimeFormatterTest01 {
    public static void main(String[] args) {
        ...
        LocalDateTime parse4 = LocalDateTime.parse("2023-02-03T11:00:26.3602489", DateTimeFormatter.ISO_DATE_TIME);
        ...
        LocalDate parseBR = LocalDate.parse("03/02/2023", formatterBR);
        System.out.println(parseBR);

        DateTimeFormatter formatterGR = DateTimeFormatter.ofPattern("dd.MMMM.yyyy", Locale.GERMANY);
        String formatGR = LocalDate.now().format(formatterGR);
        System.out.println(formatGR);
        LocalDate parseGR = LocalDate.parse("03.Februar.2023", formatterGR);
